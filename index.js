document.addEventListener("DOMContentLoaded", function() {
    ...
    // Buy ticket button event handler
    buyTicketBtn.addEventListener("click", function() {
      const ticketsRemaining = parseInt(availableTickets.textContent);
      if (ticketsRemaining > 0) {
        availableTickets.textContent = ticketsRemaining - 1;
      }
    });
